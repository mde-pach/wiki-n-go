...
Every page has a companion **discussion** area — a place to ask a question, suggest a change, or work out wording without editing the page itself. It's the wiki's version of comments.

## How it works

- Open the **Discussion** (or **Talk**) tab on any page.
...
- You're not sure about a change and want a second opinion first.
