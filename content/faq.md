...
**Is it really free?**
Yes, for normal use. Your wiki runs on the free tiers of [[w:GitHub|GitHub]] and Cloudflare, which comfortably cover an ordinary wiki. Only a very large or very busy site might eventually want a paid plan.

**Do I need to know how to code?**
No. Setting up a wiki is a few clicks (see [[create-your-wiki|Create your wiki]]), and writing pages is like writing a document. Customizing involves changing a few values in a settings file — no programming.

**How do people sign in to edit?**
Usually with GitHub or a Wikigit account, so their edits are credited to them. You can also allow anonymous editing the way Wikipedia does — credited to a nickname — or require everyone to sign in. It's your call. See [[sign-in|Letting people sign in]].

**What if someone vandalizes a page?**
Nothing is ever lost — every version is kept. You can undo a bad edit or restore an older version in a click, block the person, and even have obvious vandalism undone automatically. See [[managing|Managing changes]].
...
Yes. Your wiki starts on a free address, and you can connect your own domain whenever you like. See [[customize|Make it yours]].

**Can my wiki have more than one language?**
Yes. Pages can have versions in several languages, linked with a switcher for readers. See [[organizing|Organizing your wiki]].
